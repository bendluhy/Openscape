...
from worldgeneration.pnoise.rand_vec import RandVec
from worldgeneration.pnoise.tools import each_with_each, hasher


class PerlinNoise(object):
    """Smooth random pnoise generator.
    ...
    def __init__(self, octaves: float = 1, seed: Optional[int] = None):
        """Perlin Noise object initialization class.
            ex.: pnoise = PerlinNoise(n_dims=2, octaves=3.5, seed=777)
        Parameters:
    ...
    def __call__(self, coordinates: Union[int, float, Iterable]) -> float:
        """Forward request to pnoise function.
        Parameters:
    ...
    def noise(self, coordinates: Union[int, float, Iterable]) -> float:
        """Get perlin pnoise value for given coordinates.
        Parameters:
            coordinates: float or list of coordinates
        Returns:
            noise_value
